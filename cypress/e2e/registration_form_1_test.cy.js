...
describe('This is first test suite, Erlend Petker', () => {
    it.only('User can submit data only when valid mandatory values are added', () => {
        ...
        cy.get('[name="confirm"]').type('MyPassEP')
        cy.get('#username').type('Something')
        cy.get('#firstName').type('Erlend')
    ...
    it('User cannot submit data when password and/or confirmation password is absent', () => {
        ...
        cy.get('#firstName').type('Erlend')
        cy.get('[data-testid="lastNameTestId"]').type('Petker')
        cy.get('[data-testid="phoneNumberTestId"]').type('5566677')
    ...
    it('User cannot add letters to phone number', () => {
        ...
        // Scroll back to phone number input field
        cy.get('[data-testid="phoneNumberTestId"]').scrollIntoView()
        cy.get('[data-testid="phoneNumberTestId"]').clear().type('abc')
